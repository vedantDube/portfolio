...
const Contact = ({ isDarkMode }) => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "08df7899-e29d-439d-a44d-423ec7312630");
    ...
    >
      ...
      >
        ...
        <motion.textarea
          ...
          required
          className="w-full p-4 outlint-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6 dark:bg-darkHover/30 dark:border-white/90"
          name="message"
        ></motion.textarea>
        <motion.button
